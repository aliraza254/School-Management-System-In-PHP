                ...
                <div class="profile-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col ml-md-n2 profile-user-info">
                            <h4 class="user-name mb-0"><?php echo htmlspecialchars($_SESSION["username"]); ?></h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <p class="col-sm-9"><?php echo htmlspecialchars($_SESSION["username"]); ?></p>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <p class="col-sm-9"><a href="#" class="__cf_email__" data-cfemail="711b1e191f151e14311409101c011d145f121e1c">[email&#160;protected]</a></p>
                                        </div>
                                        <div class="row">
